...
if len(sys.argv) != 6:
    print("Usage: ./attack-tcp iface srcMAC gatewayMAC srcIP:sport-range dstIP:dport")
    print("Example:")
    print("./attack-tcp eth0 aa:bb:dd:99:88:77 aa:bb:cc:00:11:22 10.0.0.2:1024-65535 10.0.0.1:80")
    print("The source port range is inclusive.")
    print("Note: appending payload currently not implemented in this tool.")
    sys.exit(1)
...
try:
    while True:
        ...
        if time.time() - starttime > 18:
            ...
            except socket.error: # Transmit buffer probably full
                pass
            ackno = 1
            starttime = time.time()
